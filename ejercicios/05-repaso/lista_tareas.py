...
def mostrar_menu():
    print("Que accion desea realizar Ingrese el numero:\n1 - Agregar una nueva tarea a la lista de tareas pendientes.\n2 - Marcar una tarea como completada.\n3 - Mostrar todas las tareas pendientes.\n4 - Mostrar todas las tareas completadas.\n5 - Salir de la aplicación.")
...
def mostrar_tareas_pendientes():
    ...
    if len(tareas_pendientes) == 0:
        print('No hay tareas pendientes aun.')
    else:
        print('TAREAS PENDIENTES')
        for tarea in tareas_pendientes:
            print(f'{contador} - {tarea.capitalize()}')
            contador += 1
    print("===================================================")
