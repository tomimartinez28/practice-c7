...
- Los elementos estan indexados (ordenados)
- Se puedren agregar, eliminar, y modificar elementos.
"""
...
sort(key =None, reverse=False) => Ordena ascendentemente
len()
